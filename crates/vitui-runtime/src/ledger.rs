...
pub const LEDGER: [Row; 18] = [
    ...
    Row {
        ...
        used_at: "`crate::line::tests::the_frame_measured_inside_the_crate` and \
                  ...
                  a 0.19% spread and the two arms indistinguishable. It replaces the prototype's \
                  32.85-33.05, which R 17 had already found unreproducible (`91-94 us on both arms \
