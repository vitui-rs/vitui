...
//! v1 component**.
//!
//! The reduction is R4 (spec §18): the braille, block and sextant canvases are §13's ladder under
...
//!
//! `pty` is one of the two §18 exemplars that were **not** built. Its process model borders on
//! requirement 9 and may need its own ticket (§22), and recording it as two rather than waving it
//! through is spec §18's own accounting.
