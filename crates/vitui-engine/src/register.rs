...
mod tests {
    ...
    fn every_entry_of_spec_14s_register_is_present_exactly_once() {
        ...
        // properties there was no way to state, and all four were added later
